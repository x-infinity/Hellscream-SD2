...
#define TEXT_KJ_OFFCOMBAT1 "Drain the girl! Drain her power until there is nothing but a vacant shell!"
#define TEXT_KJ_OFFCOMBAT2 "Fail me, and suffer for eternity!"
#define TEXT_KJ_OFFCOMBAT3 "I have waited long enough!"
#define TEXT_KJ_OFFCOMBAT4 "Stay on task! Do not waste time!"
#define TEXT_KJ_OFFCOMBAT5 "All my plans have led to this!"
 
#define TEXT_KJ_SAY_KJ_EMERGE "The expendible have perished... So be it! Now I shall succeed where Sargeras could not! I will bleed this wretched world and secure my place as the true master of the Burning Legion. The end has come! Let the unraveling of this world commence!"
...
m_creature->MonsterYell(TEXT_KJ_SAY_KJ_EMERGE, LANG_UNIVERSAL, NULL);
...
switch (rand()%5)
{
case 0: DoPlaySoundToSet(m_creature, SAY_KJ_OFFCOMBAT1); m_creature->MonsterYell(TEXT_KJ_OFFCOMBAT1, LANG_UNIVERSAL, NULL); break;
case 1: DoPlaySoundToSet(m_creature, SAY_KJ_OFFCOMBAT2); m_creature->MonsterYell(TEXT_KJ_OFFCOMBAT2, LANG_UNIVERSAL, NULL); break;
case 2: DoPlaySoundToSet(m_creature, SAY_KJ_OFFCOMBAT3); m_creature->MonsterYell(TEXT_KJ_OFFCOMBAT3, LANG_UNIVERSAL, NULL); break;
                    case 3: DoPlaySoundToSet(m_creature, SAY_KJ_OFFCOMBAT4); m_creature->MonsterYell(TEXT_KJ_OFFCOMBAT4, LANG_UNIVERSAL, NULL); break;
                    case 4: DoPlaySoundToSet(m_creature, SAY_KJ_OFFCOMBAT5); m_creature->MonsterYell(TEXT_KJ_OFFCOMBAT5, LANG_UNIVERSAL, NULL); break;
}
