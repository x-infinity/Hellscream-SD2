...
case 1001: // Private Title
		if ((pPlayer->GetHonorPoints() >= 100) && (pPlayer->GetMoney() >=2000000))
		{
			...
			{
				pCreature->MonsterWhisper("You already have the 'Private' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Private' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
		{
			pCreature->MonsterWhisper(MSG_SHORT_ON_GOLD_OR_HONOR, pPlayer->GetGUID());
			pPlayer->CLOSE_GOSSIP_MENU();
		}
break;
...
case 1002: // Corporal Title
		if ((pPlayer->GetHonorPoints() >= 150) && (pPlayer->GetMoney() >=3000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Corporal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Corporal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1003: // Sergeant Title
		if ((pPlayer->GetHonorPoints() >= 200) && (pPlayer->GetMoney() >=4000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1004: // Master Sergeant Title
		if ((pPlayer->GetHonorPoints() >= 250) && (pPlayer->GetMoney() >=5000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Master Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Master Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1005: // Sergeant Major Title
		if ((pPlayer->GetHonorPoints() >= 300) && (pPlayer->GetMoney() >=6000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Sergeant Major' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Sergeant Major' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1006: // Knight Title
		if ((pPlayer->GetHonorPoints() >= 400) && (pPlayer->GetMoney() >=8000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Knight' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Knight' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1007: // Knight-Lieutenant Title
		if ((pPlayer->GetHonorPoints() >= 500) && (pPlayer->GetMoney() >=10000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Knight-Lieutenant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Knight-Lieutenant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1008: // Knight-Captain Title
		if ((pPlayer->GetHonorPoints() >= 650) && (pPlayer->GetMoney() >=13000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Knight-Captain' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Knight-Captain' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1009: // Knight-Champion Title
		if ((pPlayer->GetHonorPoints() >= 800) && (pPlayer->GetMoney() >=16000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Knight-Champion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Knight-Champion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1010: // Lieutenant Commander Title
		if ((pPlayer->GetHonorPoints() >= 1000) && (pPlayer->GetMoney() >=20000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Lieutenant Commander' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Lieutenant Commander' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1011: // Commander Title
		if ((pPlayer->GetHonorPoints() >= 1200) && (pPlayer->GetMoney() >=24000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Commander' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Commander' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1012: // Marshal Title
		if ((pPlayer->GetHonorPoints() >= 1500) && (pPlayer->GetMoney() >=30000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Marshal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Marshal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1013: // Field Marshal Title
		if ((pPlayer->GetHonorPoints() >= 1800) && (pPlayer->GetMoney() >=36000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Field Marshal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Field Marshal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1014: // Knight-Lieutenant Title
		if ((pPlayer->GetHonorPoints() >= 3600) && (pPlayer->GetMoney() >=72000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Marshal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Marshal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1015: // of the Alliance Title
		if ((pPlayer->GetHonorPoints() >= 5000) && (pPlayer->GetMoney() >=100000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Alliance' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Alliance' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1016: // Justicar Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Justicar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Justicar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
		{
			pCreature->MonsterWhisper("Not enough Gold!", pPlayer->GetGUID());
			pPlayer->CLOSE_GOSSIP_MENU();
		}
break;
...
case 1017: // Flame Warden Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Flame Warden' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Flame Warden' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1018: // of the Exodar Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Exodar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Exodar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1019: // of Darnassus Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Darnassus' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Darnassus' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1020: // of the Ironforge Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Ironforge' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Ironforge' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1021: // of Stormwind Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Stormwind' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Stormwind' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 1022: // of Gnomeregan Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Gnomeregan' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Gnomeregan' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2001: // Scout Title
		if ((pPlayer->GetHonorPoints() >= 100) && (pPlayer->GetMoney() >=2000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Scout' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-2000000);
				pPlayer->ModifyHonorPoints(-100);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Scout' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2002: // Grunt Title
		if ((pPlayer->GetHonorPoints() >= 150) && (pPlayer->GetMoney() >=3000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grunt' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-3000000);
				pPlayer->ModifyHonorPoints(-150);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grunt' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2004: // Senior Sergeant Title
		if ((pPlayer->GetHonorPoints() >= 250) && (pPlayer->GetMoney() >=5000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Senior Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-5000000);
				pPlayer->ModifyHonorPoints(-250);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Senior Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2005: // First Sergeant Title
		if ((pPlayer->GetHonorPoints() >= 300) && (pPlayer->GetMoney() >=6000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'First Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-6000000);
				pPlayer->ModifyHonorPoints(-300);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'First Sergeant' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2006: // Stone Guard Title
		if ((pPlayer->GetHonorPoints() >= 400) && (pPlayer->GetMoney() >=8000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Stone Guard' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-8000000);
				pPlayer->ModifyHonorPoints(-400);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Stone Guard' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2007: // Blood Guard Title
		if ((pPlayer->GetHonorPoints() >= 500) && (pPlayer->GetMoney() >=10000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Blood Guard' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-10000000);
				pPlayer->ModifyHonorPoints(-500);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Blood Guard' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2008: // Legionnaire Title
		if ((pPlayer->GetHonorPoints() >= 650) && (pPlayer->GetMoney() >=13000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Legionnaire' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-13000000);
				pPlayer->ModifyHonorPoints(-650);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Legionnaire' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2009: // Centurion Title
		if ((pPlayer->GetHonorPoints() >= 800) && (pPlayer->GetMoney() >=16000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Centurion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-16000000);
				pPlayer->ModifyHonorPoints(-800);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Centurion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2010: // Champion Title
		if ((pPlayer->GetHonorPoints() >= 1000) && (pPlayer->GetMoney() >=20000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Champion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-20000000);
				pPlayer->ModifyHonorPoints(-1000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Champion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2011: // Lieutenant General Title
		if ((pPlayer->GetHonorPoints() >= 1200) && (pPlayer->GetMoney() >=24000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Lieutenant General' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-24000000);
				pPlayer->ModifyHonorPoints(-1200);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Lieutenant General' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2012: // General Title
		if ((pPlayer->GetHonorPoints() >= 1500) && (pPlayer->GetMoney() >=30000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'General' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-30000000);
				pPlayer->ModifyHonorPoints(-1500);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'General' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2013: // Warlord Title
		if ((pPlayer->GetHonorPoints() >= 1800) && (pPlayer->GetMoney() >=36000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Warlord' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-36000000);
				pPlayer->ModifyHonorPoints(-1800);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Warlord' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2014: // High Warlord Title
		if ((pPlayer->GetHonorPoints() >= 3600) && (pPlayer->GetMoney() >=72000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'High Warlord' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-72000000);
				pPlayer->ModifyHonorPoints(-3600);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'High Warlord' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2015: // of the Horde Title
		if ((pPlayer->GetHonorPoints() >= 5000) && (pPlayer->GetMoney() >=100000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Horde' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-100000000);
				pPlayer->ModifyHonorPoints(-5000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Horde' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2016: // Conqueror Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Conqueror' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Conqueror' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2017: // Flame Keeper Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Flame Keeper' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Flame Keeper' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2018: // of Orgrimmar Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Orgrimmar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Orgrimmar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2019: // of Sen'jin Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Sen'jin' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Sen'jin' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2020: // of Silvermoon Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Silvermoon' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Silvermoon' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2021: // of Thunder Bluff Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Thunder Bluff' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Thunder Bluff' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 2022: // of the Undercity Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Undercity' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Undercity' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3001: // Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 100) && (pPlayer->GetMoney() >=2000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-2000000);
				pPlayer->ModifyHonorPoints(-100);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3002: // Duelist Title
		if ((pPlayer->GetHonorPoints() >= 200) && (pPlayer->GetMoney() >=4000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Duelist' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-4000000);
				pPlayer->ModifyHonorPoints(-200);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Duelist' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3003: // Rival Title
		if ((pPlayer->GetHonorPoints() >= 300) && (pPlayer->GetMoney() >=6000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Rival' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-6000000);
				pPlayer->ModifyHonorPoints(-300);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Rival' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3004: // Challenger Title
		if ((pPlayer->GetHonorPoints() >= 400) && (pPlayer->GetMoney() >=8000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Challenger' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-8000000);
				pPlayer->ModifyHonorPoints(-400);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Challenger' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3007: // Merciless Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 500) && (pPlayer->GetMoney() >=10000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Merciless Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-10000000);
				pPlayer->ModifyHonorPoints(-500);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Merciless Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3010: // Vengeful Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 600) && (pPlayer->GetMoney() >=12000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Vengeful Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Vengeful Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3016: // Brutal Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 700) && (pPlayer->GetMoney() >=14000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Brutal Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Brutal Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3079: // Deadly Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 800) && (pPlayer->GetMoney() >=16000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Deadly Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-16000000);
				pPlayer->ModifyHonorPoints(-800);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Deadly Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3088: // Furious Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 900) && (pPlayer->GetMoney() >=18000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Furious Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Furious Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3090: // Relentless Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 1000) && (pPlayer->GetMoney() >=20000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Relentless Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-20000000);
				pPlayer->ModifyHonorPoints(-1000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Relentless Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3098: // Wrathful Gladiator Title
		if ((pPlayer->GetHonorPoints() >= 1200) && (pPlayer->GetMoney() >=24000000))
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Wrathful Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pPlayer->ModifyMoney(-24000000);
				pPlayer->ModifyHonorPoints(-1200);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Wrathful Gladiator' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3005: // Scarab Lord Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Scarab Lord' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Scarab Lord' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3006: // Champion of the Naaru Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Champion of the Naaru' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Champion of the Naaru' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3008: // of the Shattered Sun Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Shattered Sun' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Shattered Sun' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3009: // Hand of A'dal Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Hand of A'dal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Hand of A'dal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3011: // Battlemaster Title
		if (pPlayer->GetMoney() >=150000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Battlemaster' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Battlemaster' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3012: // Elder Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Elder' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Elder' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3013: // the Exalted Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Exalted' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Exalted' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3014: // the Explorer Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Explorer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Explorer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3015: // the Diplomat Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Diplomat' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Diplomat' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3017: // the Seeker Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Seeker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Seeker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3018: // Arena Master Title
		if (pPlayer->GetMoney() >=150000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Arena Master' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-150000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Arena Master' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3019: // Salty Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Salty' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Salty' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3020: // Chef Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Chef' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Chef' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3021: // the Supreme Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Supreme' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Supreme' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3022: // of the Ten Storms Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Ten Storms' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Ten Storms' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3023: // of the Emerald Dream Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Emerald Dream' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Emerald Dream' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3024: // Prophet Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Prophet' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Prophet' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3025: // the Malefic Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Malefic' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Malefic' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3026: // Stalker Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Stalker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Stalker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3027: // of the Ebon Blade Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Ebon Blade' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Ebon Blade' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3028: // Archmage Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Archmage' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Archmage' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3029: // Warbringer Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Warbringer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Warbringer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3030: // Assassin Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Assassin' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Assassin' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3031: // Grand Master Alchemist Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Alchemist' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Alchemist' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3032: // Grand Master Blacksmith Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Blacksmith' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Blacksmith' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3033: // Iron Chef Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Iron Chef' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Iron Chef' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3034: // Grand Master Enchanter Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Enchanter' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Enchanter' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3035: // Grand Master Engineer Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Engineer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Engineer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3036: // Doctor Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Doctor' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Doctor' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3037: // Grand Master Angler Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Angler' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Angler' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3038: // Grand Master Herbalist Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Herbalist' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Herbalist' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3039: // Grand Master Scribe Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Scribe' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Scribe' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3040: // Grand Master Jewelcrafter Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Jewelcrafter' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Jewelcrafter' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3041: // Grand Master Leatherworker Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Leatherworker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Leatherworker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3042: // Grand Master Miner Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Miner' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Miner' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3043: // Grand Master Skinner Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Skinner' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Skinner' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3044: // Grand Master Tailor Title
		if (pPlayer->GetMoney() >=20000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Master Tailor' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-20000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Master Tailor' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3045: // of Quel'Thalas Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Quel'Thalas' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Quel'Thalas' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3046: // of Argus Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Argus' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Argus' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3047: // of Khaz Modan Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of Khaz Modan' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of Khaz Modan' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3048: // the Lion Hearted Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Lion Hearted' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Lion Hearted' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3049: // Champion of Elune Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Champion of Elune' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Champion of Elune' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3050: // Hero of Orgrimmar Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Hero of Orgrimmar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Hero of Orgrimmar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3051: // Plainsrunner Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Plainsrunner' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Plainsrunner' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3052: // of the Darkspear Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Darkspear' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Darkspear' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3053: // the Forsaken Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Forsaken' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Forsaken' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3054: // the Magic Seeker Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Magic Seeker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Magic Seeker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3055: // Twilight Vanquisher Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Twilight Vanquisher' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Twilight Vanquisher' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3056: // Conqueror of Naxxramas Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Conqueror of Naxxramas' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Conqueror of Naxxramas' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3057: // Hero of Northrend Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Hero of Northrend' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Hero of Northrend' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3058: // the Hallowed Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Hallowed' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Hallowed' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3059: // Loremaster Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Loremaster' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Loremaster' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3060: // the Flawless Victor Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Flawless Victor' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Flawless Victor' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3061: // the Flawless Victor Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Champion of the Frozen Wastes' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Champion of the Frozen Wastes' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3062: // Ambassador Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Ambassador' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Ambassador' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3063: // the Argent Champion Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Argent Champion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Argent Champion' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3064: // Guardian of Cenarius Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Guardian of Cenarius' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Guardian of Cenarius' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3065: // Brewmaster Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Brewmaster' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Brewmaster' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3066: // Merrymaker Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Merrymaker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Merrymaker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3067: // the Love Fool Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Love Fool' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Love Fool' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3068: // Matron Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Matron' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Matron' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3069: // Patron Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Patron' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Patron' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3070: // Obsidian Slayer Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Obsidian Slayer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Obsidian Slayer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3071: // of the Nightfall Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Nightfall' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Nightfall' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3072: // the Immortal Title
		if (pPlayer->GetMoney() >=200000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Immortal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				...
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Immortal' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3073: // the Undying Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Undying' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Undying' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3074: // Jenkins Title
		if (pPlayer->GetMoney() >=60000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Jenkins' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-60000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Jenkins' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3075: // Bloodsail Admiral Title
		if (pPlayer->GetMoney() >=40000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Bloodsail Admiral' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-40000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Bloodsail Admiral' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3076: // the Insane Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Insane' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Insane' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3077: // the Noble Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Noble' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Noble' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3078: // Crusader Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Crusader' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Crusader' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3080: // Death's Demise Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Death's Demise' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Death's Demise' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3081: // the Celestial Defender Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Celestial Defender' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Celestial Defender' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3082: // Conqueror of Ulduar Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Conqueror of Ulduar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Conqueror of Ulduar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3083: // Champion of Ulduar Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Champion of Ulduar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Champion of Ulduar' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3084: // Vanquisher Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Vanquisher' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Vanquisher' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3085: // Starcaller Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Starcaller' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Starcaller' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3086: // the Astral Walker Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Astral Walker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Astral Walker' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3087: // Herald of the Titans Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Herald of the Titans' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Herald of the Titans' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3089: // the Pilgrim Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Pilgrim' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Pilgrim' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3091: // Grand Crusader Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Grand Crusader' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Grand Crusader' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3092: // the Argent Defender Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Argent Defender' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Argent Defender' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3093: // the Patient Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Patient' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Patient' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3094: // the Light of Dawn Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Light of Dawn' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Light of Dawn' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3095: // Bane of the Fallen King Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'Bane of the Fallen King' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'Bane of the Fallen King' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3096: // the Kingslayer Title
		if (pPlayer->GetMoney() >=100000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'the Kingslayer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-100000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'the Kingslayer' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
...
case 3097: // of the Ashen Verdict Title
		if (pPlayer->GetMoney() >=80000000)
		{
			...
			if (pPlayer->HasTitle(titleEntry))
			{
				pCreature->MonsterWhisper("You already have the 'of the Ashen Verdict' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
			else
			{
				pPlayer->SetTitle(titleEntry);
				pPlayer->ModifyMoney(-80000000);
				pCreature->MonsterWhisper("Congratulations! You've just gained 'of the Ashen Verdict' Title!", pPlayer->GetGUID());
				pPlayer->CLOSE_GOSSIP_MENU();
			}
		}
		else
