...
{ 
    ...
    { 
        ...
        { 
                m_creature->SummonCreature(NPC_SCHLUND, 580.457764, 177.184662, 395.136548, 1.565907, TEMPSUMMON_DEAD_DESPAWN, 0); 
                m_creature->SummonCreature(NPC_GORMOK, 563.768555, 179.513672, 394.398224, 4.687868, TEMPSUMMON_DEAD_DESPAWN, 0); 
                m_creature->SummonCreature(NPC_MAUL, 544.791504, 174.521866, 394.679626, 5.363310, TEMPSUMMON_DEAD_DESPAWN, 0); 
        ...
        { 
                m_creature->SummonCreature(NPC_ICE, 563.768555, 179.513672, 394.398224, 4.687868, TEMPSUMMON_DEAD_DESPAWN, 0); 
        ...
        { 
	    m_creature->SummonCreature(NPC_HOLY, 580.457764, 177.184662, 395.136548, 1.565907, TEMPSUMMON_MANUAL_DESPAWN, 0); 
        m_creature->SummonCreature(NPC_SHADOW, 544.791504, 174.521866, 394.679626, 5.363310, TEMPSUMMON_MANUAL_DESPAWN, 0); 
        ...
        { 
	    m_creature->SummonCreature(NPC_JARU, 563.768555, 179.513672, 394.398224, 4.687868, TEMPSUMMON_MANUAL_DESPAWN, 0); 
        ...
        { 
	    m_creature->SummonCreature(NPC_ANUB, 563.768555, 179.513672, 394.398224, 4.687868, TEMPSUMMON_MANUAL_DESPAWN, 0); 
