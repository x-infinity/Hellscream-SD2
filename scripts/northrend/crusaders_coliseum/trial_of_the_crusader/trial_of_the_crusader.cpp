...
{"You are ready to continue battle with Anub-Arak?",GOSSIP_ACTION_INFO_DEF+6,true,TYPE_LICH_KING}, //
{"Do not poke here. Today arena is closed.",GOSSIP_ACTION_INFO_DEF+7,true,TYPE_ANUBARAK}, //
};
enum
{
         NUM_MESSAGES = 7,
